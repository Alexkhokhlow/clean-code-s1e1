...
var incompleteTaskHolder=document.getElementsByClassName("todo__list")[0];//ul of #incomplete-tasks
...
//select ListItems children
    ...
    var editButton=taskListItem.getElementsByClassName("button-edit")[0];
    var deleteButton=taskListItem.getElementsByClassName("button-delete")[0];
